...
export interface ApiCatalogueCoffretsCatalogueCoffrets
  ...
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    Informations_complementaires: Schema.Attribute.Blocks;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
      'oneToMany',
...
export interface ApiLaBoutiqueLaBoutique extends Struct.SingleTypeSchema {
  collectionName: 'la_boutique_list';
  info: {
    displayName: 'La Boutique';
    pluralName: 'la-boutique-list';
    singularName: 'la-boutique';
  };
  options: {
    draftAndPublish: true;
  };
...
export interface ApiNotreHistoireNotreHistoire extends Struct.SingleTypeSchema {
  ...
  info: {
    ...
    pluralName: 'notre-histoires';
    singularName: 'notre-histoire';
  };
  options: {
    draftAndPublish: true;
  };
  attributes: {
    ...
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::notre-histoire.notre-histoire'
    > &
      Schema.Attribute.Private;
    Mise_en_valeur: Schema.Attribute.String;
